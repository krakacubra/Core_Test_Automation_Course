...
public class TestMapProperties {
    ...
    MapProperties mapWithoutKey = new MapProperties();
    @Before
    ...
    public void fillPropertiesMustThrowExceptionAfterSecondReadOfFile() throws ReadJustOnceException, IOException{
